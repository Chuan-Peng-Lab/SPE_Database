...
3. **subj_info 已全覆盖（2026-08-27）**：全库 56 个 `*_subj_info.csv`——Orellana-Corrales_2021_APP ×2 与 Sui_2015_unpub ×2 由 Clean.csv 唯一 Subject / `*_Raw/` 人口学记录生成（无原始数据，人口学部分为 /；原记录已随 PROJ_STATE.md 历史精简，见其 §7 归档说明）
