...
output_file_name <- "Zhang_2023_NI_Exp1_subj_info.csv"
...
output_file_name <- "Wang_2016_EPHPP_Exp1_subj_info.csv"
output_data_path <- file.path(dirname(raw_data_path), output_file_name)  # 自动拼接输出路径（和原文件同目录）
...
output_file_name <- "Svensson_2023_QJEP_Exp1_subj_info.csv"
output_data_path <- file.path(dirname(raw_data_path), output_file_name)  # 自动拼接输出路径（和原文件同目录）
...
output_file_name <- "Svensson_2021_PR_Exp3_subj_info.csv"
output_data_path <- file.path(dirname(raw_data_path), output_file_name)  # 自动拼接输出路径（和原文件同目录）
...
output_file_name <- "Sun_2025_Exp1_subj_info.csv"
output_data_path <- file.path(dirname(raw_data_path), output_file_name)  # 自动拼接输出路径（和原文件同目录）
...
output_file_name <- "Smith_2024_Cortex_Exp1_subj_info.csv"
output_data_path <- file.path(dirname(raw_data_path), output_file_name)  # 自动拼接输出路径（和原文件同目录）
...
output_file_name <- "Pan_2025_Exp1_subj_info.csv"
output_data_path <- file.path(dirname(raw_data_path), output_file_name)  # 自动拼接输出路径（和原文件同目录）
...
output_file_name <- "Orellana-Corrales_2021_EP_Exp3_subj_info.csv"
output_data_path <- file.path(dirname(raw_data_path), output_file_name)  # 自动拼接输出路径（和原文件同目录）
...
output_file_name <- "Orellana-Corrales_2021_EP_Exp1_subj_info.csv"
output_data_path <- file.path(dirname(raw_data_path), output_file_name)  # 自动拼接输出路径（和原文件同目录）
...
output_file_name <- "Dalmaso_2024_CC_Exp2_subj_info.csv"
output_data_path <- file.path(dirname(raw_data_path), output_file_name)  # 自动拼接输出路径（和原文件同目录）
...
output_file_name <- "Orellana-Corrales_2021_APP_Exp2_subj_info.csv"
output_data_path <- file.path(dirname(raw_data_path), output_file_name)  # 自动拼接输出路径（和原文件同目录）
