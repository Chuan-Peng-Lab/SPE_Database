...
# 1. 定义文件路径（解耦路径，便于维护）
raw_data_path <- "../1_Data/Lee_2023_Cognition/Exp2/Lee_2023_Cognition_Exp2_raw.csv"
output_file_name <- "Lee_2023_Cognition_Exp2_raw_Subject.csv"
...
result_1 <- extract_and_standardize(
  df = data_1,
  selected_cols = c("subject","age","sex","education","handedness"),
  rename_map = list("subject" = "Subject_ID",
                    "age" = "Age",
                    "sex" = "Gender",
                    "handedness" = "Handedness",
